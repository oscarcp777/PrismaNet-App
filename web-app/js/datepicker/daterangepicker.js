...
!function ($) {
        ...
        if (hasOptions) {
            ...
            if (typeof options.ranges == 'object') {
                for (var range in options.ranges) {
                    ...
                    var rangeId=options.ranges[range][2];
                    ...
                    this.ranges[range] = [start, end,rangeId];
                }
    ...
    DateRangePicker.prototype = {
        ...
        notify: function () {
            this.updateView();
            this.cb(this.startDate, this.endDate,this.rangeSelect);
        },
        ...
        clickRange: function (e) {
            ...
            if (label == this.locale.customRangeLabel) {
                this.showCalendars();
                this.rangeSelect='customRange';
            } else {
                var dates = this.ranges[label];
                this.startDate = dates[0];
                this.endDate = dates[1];
                this.rangeSelect=dates[2];
                if (!this.timePicker) {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (!minDate || minDate.isBefore(calendar[1][1])) {
                html += '<th class="prev available"><i class="fa fa-arrow-left fa-angle-left"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar[1][1])) {
                html += '<th class="next available"><i class="fa fa-arrow-right fa-angle-right"></i></th>';
            } else {
                html += '<th></th>';
            }
