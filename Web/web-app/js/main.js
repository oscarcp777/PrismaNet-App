$(document).ready(function ($) {
	...
	$('#section4 .article-tags li').on('click', function () {
	    ...
	    var section = $(this).parents('#article-id');
    ...
    function changeColorHeader(datasection){
    	if (datasection == 2 || datasection == 4) {
        	$("#header").css('background-color', '#ecf0f1');
        }else{
    ...
    function goToByScroll(datasection) {
        ...
        if (datasection == 1) {
	        ...
	        htmlbody.animate({
	            scrollTop: $('.section[data-section="' + datasection + '"]').offset().top + 70 }, 500, 'easeOutQuart');
        }
        changeColorHeader(datasection);
