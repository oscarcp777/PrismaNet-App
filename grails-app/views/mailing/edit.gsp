...
<html>
	...
	<div class="page-content">
		...
		<hr>
		<div id="edit-mailing" class="content scaffold-edit" role="main">
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${mailingInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${mailingInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${mailingInstance?.version}" />
				<fieldset class="form">
