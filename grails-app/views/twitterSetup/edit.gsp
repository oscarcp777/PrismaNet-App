...
<html>
	...
	<body>
		<a href="#edit-twitterSetup" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-twitterSetup" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${twitterSetupInstance?.version}" />
				<fieldset class="form">
