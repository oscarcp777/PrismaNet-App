...
<body>
	<div class="page-content">
		<div class="page-header">
			<h1>
				<i class="fa fa-cogs"></i>  <g:message code="controlPanel.title"/>
			</h1>
		</div>
