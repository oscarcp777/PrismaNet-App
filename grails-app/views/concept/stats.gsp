				...
				<div class="col-xs-12 col-sm-12 widget-container-span ui-sortable">
						<div class="widget-box">
							...
							<div class="widget-body">
								<div class="widget-body-inner" style="display: block;">
									<div class="widget-main">
										<div id="lineaChartConcept" style="height: 400px; min-width: 310px"></div>
									</div>
	...
	<script type="text/javascript">
		...
		function loadCharLineConcepts(start, end, rangeSelect) {
		     $('#pickertConcept span').html(rangeSelect+' - '+start.format('LLLL') + ' - ' + end.format('LLLL'));
   		     var data = {"id":${concept.id}, "div":'#lineaChartConcept',"dateFrom":start.format('L HH:mm'),"dateTo":end.format('L HH:mm')};
	  ...
	  $(function() {
		  ...
		  var id='${concept.id}';
		   ...
		   var data = {"id":${concept.id}, "div":'#lineaChartConcept',"dateFrom":moment().subtract('days', 29).format('L HH:mm'),"dateTo":moment().format('L HH:mm')};
		   getGroupedTweets(data);
		});
	</script>
</body>
