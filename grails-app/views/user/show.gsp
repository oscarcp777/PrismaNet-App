	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="concepts-label" class="property-label"><g:message code="user.concepts.label" default="Concepts" /></span>
				...
				<li class="fieldcontain">
					<span id="twitterAccounts-label" class="property-label"><g:message code="user.twitterAccounts.label" default="Twitter Accounts" /></span>
