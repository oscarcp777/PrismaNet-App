...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'concepts', 'error')} ">
	<label for="concepts">
...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'twitterAccounts', 'error')} ">
	<label for="twitterAccounts">
